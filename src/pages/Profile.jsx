...
<div className="items-center justify-center p-4 sm:p-2 ">
      ...
      <h3 className="text-lg font-semibold hover:text-blue-400 cursor-pointer ">My Posts</h3>
      <h3 className="text-lg font-semibold hover:text-blue-400 cursor-pointer ">Favorites</h3>
      <h3 className="text-lg font-semibold hover:text-blue-400 cursor-pointer ">Settings</h3>
      </div>
      <div className="flex items-center justify-between p-4 sm:p-2 ">
      <input
